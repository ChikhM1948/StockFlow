      ...
      {customers.length === 0 ? (
        <View className="bg-white border border-dashed border-slate-300 rounded-2xl p-6 items-center">
          <View className="w-12 h-12 rounded-2xl bg-slate-100 items-center justify-center mb-3">
            <UserRound size={22} color="#64748B" />
          </View>
          <Text className="text-slate-900 font-bold">Aucun client</Text>
          <Text className="text-slate-500 text-sm text-center mt-1">Les clients avec des ventes apparaîtront ici.</Text>
        </View>
      ) : (
